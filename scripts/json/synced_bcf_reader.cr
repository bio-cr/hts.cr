...
fun bcf_sr_strerror(Int32) : LibC::Char*
# fun bcf_sr_set_opt(*, ) : Int32
# fun bcf_sr_set_threads(*, Int32) : Int32
# fun bcf_sr_destroy_threads(*) : Void
# fun bcf_sr_add_reader(*, LibC::Char*) : Int32
# fun bcf_sr_remove_reader(*, Int32) : Void
# fun bcf_sr_next_line(*) : Int32
# fun bcf_sr_seek(*, LibC::Char*, ) : Int32
# fun bcf_sr_set_samples(*, LibC::Char*, Int32) : Int32
# fun bcf_sr_set_targets(*, LibC::Char*, Int32, Int32) : Int32
# fun bcf_sr_set_regions(*, LibC::Char*, Int32) : Int32
# fun bcf_sr_regions_init(LibC::Char*, Int32, Int32, Int32, Int32) : *
# fun bcf_sr_regions_destroy(*) : Void
# fun bcf_sr_regions_seek(*, LibC::Char*) : Int32
# fun bcf_sr_regions_next(*) : Int32
# fun bcf_sr_regions_overlap(*, LibC::Char*, , ) : Int32
# fun bcf_sr_regions_flush(*) : Int32

# Unknown types
# ["__time_t", "__suseconds_t", "__syscall_slong_t", ":array", ":enum", "struct", ":bitfield", "kstring_t", "union", "htsFormat", "hts_idx_t", ":struct", "hts_pos_t", "hts_pair_pos_t", "hts_reglist_t", "hts_pair64_max_t", ":function-pointer", "bcf_idinfo_t", "bcf_hrec_t", "bcf_info_t", "bcf_fmt_t", "bcf_variant_t", "bcf_dec_t", "tbx_conf_t", "tbx_t", "hts_itr_t", "htsFile", "bcf_hdr_t", "bcf1_t", "bcf_sr_error", "bcf_sr_t", "bcf_sr_regions_t", "htsThreadPool", "intmax_t", "imaxdiv_t", "uintmax_t", "__gwchar_t", ":long-double", "fd_set", "__sigset_t", "__compar_fn_t", "div_t", "ldiv_t", "lldiv_t", "wchar_t", "locale_t", "FILE", "__gnuc_va_list", "__off_t", "fpos_t", "va_list", "ks_tokaux_t", "hts_opt", ":pointer", "hts_name2id_f", "BGZF", "hts_id2name_f", "errmod_t", "probaln_par_t", "hts_md5_context", ":unsigned-char", "bcf_srs_t", "bcf_sr_opt_t"]
# timeval, __time_t
...
# tbx_t, tbx_conf_t
# tbx_t, hts_idx_t
# bcf_sr_regions_t, tbx_t
# bcf_sr_regions_t, hts_itr_t
# bcf_sr_regions_t, kstring_t
# bcf_sr_regions_t, htsFile
# bcf_sr_regions_t, kstring_t
# bcf_sr_regions_t, :function-pointer
# bcf_sr_regions_t, struct
# bcf_sr_regions_t, hts_pos_t
# bcf_sr_regions_t, hts_pos_t
# bcf_sr_regions_t, hts_pos_t
# bcf_sr_regions_t, hts_pos_t
# bcf_sr_t, htsFile
...
# bcf_sr_t, hts_itr_t
# bcf_sr_t, bcf1_t
# bcf_srs_t, bcf_sr_error
# bcf_srs_t, bcf_sr_t
# bcf_srs_t, bcf_sr_regions_t
# bcf_srs_t, bcf_sr_regions_t
# bcf_srs_t, kstring_t
# bcf_srs_t, htsThreadPool
# imaxabs, intmax_t
# imaxabs, intmax_t
# imaxdiv, intmax_t
# imaxdiv, intmax_t
...
# tbx_destroy, tbx_t
# bcf_sr_init, bcf_srs_t
# bcf_sr_destroy, bcf_srs_t
# bcf_sr_set_opt, bcf_srs_t
# bcf_sr_set_opt, bcf_sr_opt_t
# bcf_sr_set_threads, bcf_srs_t
# bcf_sr_destroy_threads, bcf_srs_t
# bcf_sr_add_reader, bcf_srs_t
# bcf_sr_remove_reader, bcf_srs_t
# bcf_sr_next_line, bcf_srs_t
# bcf_sr_seek, bcf_srs_t
# bcf_sr_seek, hts_pos_t
# bcf_sr_set_samples, bcf_srs_t
# bcf_sr_set_targets, bcf_srs_t
# bcf_sr_set_regions, bcf_srs_t
# bcf_sr_regions_init, bcf_sr_regions_t
# bcf_sr_regions_destroy, bcf_sr_regions_t
# bcf_sr_regions_seek, bcf_sr_regions_t
# bcf_sr_regions_next, bcf_sr_regions_t
# bcf_sr_regions_overlap, bcf_sr_regions_t
# bcf_sr_regions_overlap, hts_pos_t
# bcf_sr_regions_overlap, hts_pos_t
# bcf_sr_regions_flush, bcf_sr_regions_t
