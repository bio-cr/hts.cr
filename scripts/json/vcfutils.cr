...
# bcf_trim_alleles, bcf_hdr_t, convert.rb:100:in `block (2 levels) in <main>'
# bcf_trim_alleles, bcf1_t, convert.rb:100:in `block (2 levels) in <main>'
# bcf_remove_alleles, bcf_hdr_t, convert.rb:100:in `block (2 levels) in <main>'
# bcf_remove_alleles, bcf1_t, convert.rb:100:in `block (2 levels) in <main>'
# bcf_remove_allele_set, bcf_hdr_t, convert.rb:100:in `block (2 levels) in <main>'
# bcf_remove_allele_set, bcf1_t, convert.rb:100:in `block (2 levels) in <main>'
# bcf_remove_allele_set, struct, convert.rb:100:in `block (2 levels) in <main>'
# bcf_calc_ac, bcf_hdr_t, convert.rb:100:in `block (2 levels) in <main>'
# bcf_calc_ac, bcf1_t, convert.rb:100:in `block (2 levels) in <main>'
# bcf_gt_type, bcf_fmt_t, convert.rb:100:in `block (2 levels) in <main>'
