...
fun fai_build3(LibC::Char*, LibC::Char*, LibC::Char*) : Int32
fun fai_build(LibC::Char*) : Int32
# fun fai_destroy(*) : Void
# fun fai_load3(LibC::Char*, LibC::Char*, LibC::Char*, Int32) : *
# fun fai_load(LibC::Char*) : *
# fun fai_load3_format(LibC::Char*, LibC::Char*, LibC::Char*, Int32, ) : *
# fun fai_load_format(LibC::Char*, ) : *
# fun fai_fetch(*, LibC::Char*, Int32*) : LibC::Char*
# fun fai_fetch64(*, LibC::Char*, *) : LibC::Char*
# fun fai_fetchqual(*, LibC::Char*, Int32*) : LibC::Char*
# fun fai_fetchqual64(*, LibC::Char*, *) : LibC::Char*
# fun faidx_fetch_nseq(*) : Int32
# fun faidx_fetch_seq(*, LibC::Char*, Int32, Int32, Int32*) : LibC::Char*
# fun faidx_fetch_seq64(*, LibC::Char*, , , *) : LibC::Char*
# fun faidx_fetch_qual(*, LibC::Char*, Int32, Int32, Int32*) : LibC::Char*
# fun faidx_fetch_qual64(*, LibC::Char*, , , *) : LibC::Char*
# fun faidx_has_seq(*, LibC::Char*) : Int32
# fun faidx_nseq(*) : Int32
# fun faidx_iseq(*, Int32) : LibC::Char*
# fun faidx_seq_len(*, LibC::Char*) : Int32
# fun fai_parse_region(*, LibC::Char*, Int32*, *, *, Int32) : LibC::Char*
# fun fai_set_cache_size(*, Int32) : Void
fun fai_path(LibC::Char*) : LibC::Char*

# Unknown types
# ["__time_t", "__suseconds_t", "__syscall_slong_t", ":array", ":enum", "struct", ":bitfield", "kstring_t", "union", "htsFormat", "hts_idx_t", ":struct", "hts_pos_t", "hts_pair_pos_t", "hts_reglist_t", "hts_pair64_max_t", ":function-pointer", "intmax_t", "imaxdiv_t", "uintmax_t", "__gwchar_t", ":long-double", "fd_set", "__sigset_t", "__compar_fn_t", "div_t", "ldiv_t", "lldiv_t", "wchar_t", "locale_t", "FILE", "__gnuc_va_list", "__off_t", "fpos_t", "va_list", "ks_tokaux_t", "hts_opt", "htsFile", ":pointer", "htsThreadPool", "hts_name2id_f", "hts_itr_t", "BGZF", "hts_id2name_f", "errmod_t", "probaln_par_t", "hts_md5_context", ":unsigned-char", "faidx_t"]
# timeval, __time_t
...
# fai_load3, faidx_t
# fai_load, faidx_t
# fai_load3_format, :enum
# fai_load3_format, faidx_t
# fai_load_format, :enum
# fai_load_format, faidx_t
# fai_fetch, faidx_t
# fai_fetch64, faidx_t
# fai_fetch64, hts_pos_t
# fai_fetchqual, faidx_t
# fai_fetchqual64, faidx_t
# fai_fetchqual64, hts_pos_t
# faidx_fetch_nseq, faidx_t
# faidx_fetch_seq, faidx_t
# faidx_fetch_seq64, faidx_t
# faidx_fetch_seq64, hts_pos_t
# faidx_fetch_seq64, hts_pos_t
# faidx_fetch_seq64, hts_pos_t
# faidx_fetch_qual, faidx_t
# faidx_fetch_qual64, faidx_t
# faidx_fetch_qual64, hts_pos_t
# faidx_fetch_qual64, hts_pos_t
# faidx_fetch_qual64, hts_pos_t
# faidx_has_seq, faidx_t
# faidx_nseq, faidx_t
# faidx_iseq, faidx_t
# faidx_seq_len, faidx_t
# fai_parse_region, faidx_t
# fai_parse_region, hts_pos_t
# fai_parse_region, hts_pos_t
# fai_set_cache_size, faidx_t
