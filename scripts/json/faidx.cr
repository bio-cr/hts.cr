...
fun fai_build3(UInt8*, UInt8*, UInt8*) : Int32
fun fai_build(UInt8*) : Int32
# fun fai_destroy(*) : Void
# fun fai_load3(UInt8*, UInt8*, UInt8*, Int32) : *
# fun fai_load(UInt8*) : *
# fun fai_load3_format(UInt8*, UInt8*, UInt8*, Int32, ) : *
# fun fai_load_format(UInt8*, ) : *
# fun fai_fetch(*, UInt8*, Int32*) : UInt8*
# fun fai_fetch64(*, UInt8*, *) : UInt8*
# fun fai_fetchqual(*, UInt8*, Int32*) : UInt8*
# fun fai_fetchqual64(*, UInt8*, *) : UInt8*
# fun faidx_fetch_nseq(*) : Int32
# fun faidx_fetch_seq(*, UInt8*, Int32, Int32, Int32*) : UInt8*
# fun faidx_fetch_seq64(*, UInt8*, , , *) : UInt8*
# fun faidx_fetch_qual(*, UInt8*, Int32, Int32, Int32*) : UInt8*
# fun faidx_fetch_qual64(*, UInt8*, , , *) : UInt8*
# fun faidx_has_seq(*, UInt8*) : Int32
# fun faidx_nseq(*) : Int32
# fun faidx_iseq(*, Int32) : UInt8*
# fun faidx_seq_len(*, UInt8*) : Int32
# fun fai_parse_region(*, UInt8*, Int32*, *, *, Int32) : UInt8*
# fun fai_set_cache_size(*, Int32) : Void
fun fai_path(UInt8*) : UInt8*

# Unknow types
# ["__time_t", "__suseconds_t", "__syscall_slong_t", ":pointer", "__pthread_list_t", ":array", "union", "__off_t", "__mbstate_t", "__off64_t", ":enum", "struct", ":bitfield", "kstring_t", "htsFormat", "hts_pos_t", ":function-pointer", "intmax_t", "imaxdiv_t", "uintmax_t", "__gwchar_t", ":long-double", "fd_set", ":struct", "__sigset_t", "__compar_fn_t", "div_t", "ldiv_t", "lldiv_t", "wchar_t", "locale_t", "FILE", "__gnuc_va_list", "fpos_t", "va_list", "ks_tokaux_t", "hts_opt", "htsFile", "htsThreadPool", "hts_idx_t", "hts_name2id_f", "hts_itr_t", "BGZF", "hts_id2name_f", "hts_reglist_t", "errmod_t", "probaln_par_t", "hts_md5_context", ":unsigned-char", "faidx_t"]
# caller
...
# hts_reg2bin, hts_pos_t, convert.rb:104:in `block (2 levels) in <main>'
# fai_destroy, faidx_t, convert.rb:100:in `block (2 levels) in <main>'
# , faidx_t, convert.rb:109:in `block in <main>'
# , faidx_t, convert.rb:109:in `block in <main>'
# fai_load3_format, :enum, convert.rb:104:in `block (2 levels) in <main>'
# , faidx_t, convert.rb:109:in `block in <main>'
# fai_load_format, :enum, convert.rb:104:in `block (2 levels) in <main>'
# , faidx_t, convert.rb:109:in `block in <main>'
# fai_fetch, faidx_t, convert.rb:100:in `block (2 levels) in <main>'
# fai_fetch64, faidx_t, convert.rb:100:in `block (2 levels) in <main>'
# fai_fetch64, hts_pos_t, convert.rb:100:in `block (2 levels) in <main>'
# fai_fetchqual, faidx_t, convert.rb:100:in `block (2 levels) in <main>'
# fai_fetchqual64, faidx_t, convert.rb:100:in `block (2 levels) in <main>'
# fai_fetchqual64, hts_pos_t, convert.rb:100:in `block (2 levels) in <main>'
# faidx_fetch_nseq, faidx_t, convert.rb:100:in `block (2 levels) in <main>'
# faidx_fetch_seq, faidx_t, convert.rb:100:in `block (2 levels) in <main>'
# faidx_fetch_seq64, faidx_t, convert.rb:100:in `block (2 levels) in <main>'
# faidx_fetch_seq64, hts_pos_t, convert.rb:104:in `block (2 levels) in <main>'
# faidx_fetch_seq64, hts_pos_t, convert.rb:104:in `block (2 levels) in <main>'
# faidx_fetch_seq64, hts_pos_t, convert.rb:100:in `block (2 levels) in <main>'
# faidx_fetch_qual, faidx_t, convert.rb:100:in `block (2 levels) in <main>'
# faidx_fetch_qual64, faidx_t, convert.rb:100:in `block (2 levels) in <main>'
# faidx_fetch_qual64, hts_pos_t, convert.rb:104:in `block (2 levels) in <main>'
# faidx_fetch_qual64, hts_pos_t, convert.rb:104:in `block (2 levels) in <main>'
# faidx_fetch_qual64, hts_pos_t, convert.rb:100:in `block (2 levels) in <main>'
# faidx_has_seq, faidx_t, convert.rb:100:in `block (2 levels) in <main>'
# faidx_nseq, faidx_t, convert.rb:100:in `block (2 levels) in <main>'
# faidx_iseq, faidx_t, convert.rb:100:in `block (2 levels) in <main>'
# faidx_seq_len, faidx_t, convert.rb:100:in `block (2 levels) in <main>'
# fai_parse_region, faidx_t, convert.rb:100:in `block (2 levels) in <main>'
# fai_parse_region, hts_pos_t, convert.rb:100:in `block (2 levels) in <main>'
# fai_parse_region, hts_pos_t, convert.rb:100:in `block (2 levels) in <main>'
# fai_set_cache_size, faidx_t, convert.rb:100:in `block (2 levels) in <main>'
