...
fun isalnum(Int32) : Int32
fun isalpha(Int32) : Int32
fun iscntrl(Int32) : Int32
fun isdigit(Int32) : Int32
fun islower(Int32) : Int32
fun isgraph(Int32) : Int32
fun isprint(Int32) : Int32
fun ispunct(Int32) : Int32
fun isspace(Int32) : Int32
fun isupper(Int32) : Int32
fun isxdigit(Int32) : Int32
fun tolower(Int32) : Int32
fun toupper(Int32) : Int32
fun isblank(Int32) : Int32
fun isascii(Int32) : Int32
fun toascii(Int32) : Int32
fun _toupper(Int32) : Int32
fun _tolower(Int32) : Int32
# fun isalnum_l(Int32, ) : Int32
# fun isalpha_l(Int32, ) : Int32
# fun iscntrl_l(Int32, ) : Int32
# fun isdigit_l(Int32, ) : Int32
# fun islower_l(Int32, ) : Int32
# fun isgraph_l(Int32, ) : Int32
# fun isprint_l(Int32, ) : Int32
# fun ispunct_l(Int32, ) : Int32
# fun isspace_l(Int32, ) : Int32
# fun isupper_l(Int32, ) : Int32
# fun isxdigit_l(Int32, ) : Int32
# fun isblank_l(Int32, ) : Int32
# fun __tolower_l(Int32, ) : Int32
# fun tolower_l(Int32, ) : Int32
# fun __toupper_l(Int32, ) : Int32
# fun toupper_l(Int32, ) : Int32
...
# Unknow types
# [":array", ":pointer", "__time_t", "__suseconds_t", "__syscall_slong_t", "__pthread_list_t", "union", "__off_t", "__mbstate_t", "__off64_t", "locale_t", ":long-double", "fd_set", ":struct", "__sigset_t", ":function-pointer", "__compar_fn_t", "div_t", "ldiv_t", "lldiv_t", "wchar_t", "FILE", "__gnuc_va_list", "fpos_t", "kstring_t", "va_list", "ks_tokaux_t"]
# caller
...
# , :pointer, convert.rb:109:in `block in <main>'
# , :pointer, convert.rb:109:in `block in <main>'
# isalnum_l, locale_t, convert.rb:104:in `block (2 levels) in <main>'
# isalpha_l, locale_t, convert.rb:104:in `block (2 levels) in <main>'
# iscntrl_l, locale_t, convert.rb:104:in `block (2 levels) in <main>'
# isdigit_l, locale_t, convert.rb:104:in `block (2 levels) in <main>'
# islower_l, locale_t, convert.rb:104:in `block (2 levels) in <main>'
# isgraph_l, locale_t, convert.rb:104:in `block (2 levels) in <main>'
# isprint_l, locale_t, convert.rb:104:in `block (2 levels) in <main>'
# ispunct_l, locale_t, convert.rb:104:in `block (2 levels) in <main>'
# isspace_l, locale_t, convert.rb:104:in `block (2 levels) in <main>'
# isupper_l, locale_t, convert.rb:104:in `block (2 levels) in <main>'
# isxdigit_l, locale_t, convert.rb:104:in `block (2 levels) in <main>'
# isblank_l, locale_t, convert.rb:104:in `block (2 levels) in <main>'
# __tolower_l, locale_t, convert.rb:104:in `block (2 levels) in <main>'
# tolower_l, locale_t, convert.rb:104:in `block (2 levels) in <main>'
# __toupper_l, locale_t, convert.rb:104:in `block (2 levels) in <main>'
# toupper_l, locale_t, convert.rb:104:in `block (2 levels) in <main>'
