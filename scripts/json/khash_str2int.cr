...
# fun __ac_X31_hash_string(LibC::Char*) : 
...
fun khash_str2int_has_key(Void*, LibC::Char*) : Int32
fun khash_str2int_get(Void*, LibC::Char*, Int32*) : Int32
fun khash_str2int_inc(Void*, LibC::Char*) : Int32
fun khash_str2int_set(Void*, LibC::Char*, Int32) : Int32
fun khash_str2int_size(Void*) : Int32

# Unknown types
# ["__time_t", "__suseconds_t", "__syscall_slong_t", ":array", "khint_t", "khint32_t", "kh_cstr_t", ":long-double", "fd_set", ":struct", "__sigset_t", ":function-pointer", "__compar_fn_t", "div_t", "ldiv_t", "lldiv_t", "wchar_t", "locale_t", "FILE", "__gnuc_va_list", "__off_t", "fpos_t", "kstring_t", "va_list", "ks_tokaux_t", "kh_str2int_t"]
# timeval, __time_t
...
# drand48_data, :array
# ks_tokaux_t, :array
# kh_str2int_s, khint_t
# kh_str2int_s, khint_t
# kh_str2int_s, khint_t
# kh_str2int_s, khint_t
# kh_str2int_s, khint32_t
# kh_str2int_s, kh_cstr_t
# strtold, :long-double
# select, fd_set
# select, fd_set
# select, fd_set
...
# kputl, kstring_t
# ksplit, kstring_t
# __ac_X31_hash_string, khint_t
# __ac_X31_hash_kstring, kstring_t
# __ac_X31_hash_kstring, khint_t
# __ac_Wang_hash, khint_t
# __ac_Wang_hash, khint_t
# kh_init_str2int, kh_str2int_t
# kh_destroy_str2int, kh_str2int_t
# kh_clear_str2int, kh_str2int_t
# kh_get_str2int, kh_str2int_t
# kh_get_str2int, kh_cstr_t
# kh_get_str2int, khint_t
# kh_resize_str2int, kh_str2int_t
# kh_resize_str2int, khint_t
# kh_put_str2int, kh_str2int_t
# kh_put_str2int, kh_cstr_t
# kh_put_str2int, khint_t
# kh_del_str2int, kh_str2int_t
# kh_del_str2int, khint_t
