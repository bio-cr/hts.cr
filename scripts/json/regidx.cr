...
# fun regidx_parse_bed(UInt8*, UInt8**, UInt8**, *, *, Void*, Void*) : Int32
# fun regidx_parse_tab(UInt8*, UInt8**, UInt8**, *, *, Void*, Void*) : Int32
# fun regidx_parse_reg(UInt8*, UInt8**, UInt8**, *, *, Void*, Void*) : Int32
# fun regidx_parse_vcf(UInt8*, UInt8**, UInt8**, *, *, Void*, Void*) : Int32
# fun regidx_init(UInt8*, , , SizeT, Void*) : *
# fun regidx_init_string(UInt8*, , , SizeT, Void*) : *
# fun regidx_destroy(*) : Void
# fun regidx_overlap(*, UInt8*, , , *) : Int32
# fun regidx_insert(*, UInt8*) : Int32
# fun regidx_insert_list(*, UInt8*, UInt8) : Int32
# fun regidx_push(*, UInt8*, UInt8*, , , Void*) : Int32
# fun regidx_seq_names(*, Int32*) : *
# fun regidx_seq_nregs(*, UInt8*) : Int32
# fun regidx_nregs(*) : Int32
# fun regitr_init(*) : *
# fun regitr_destroy(*) : Void
# fun regitr_reset(*, *) : Void
# fun regitr_overlap(*) : Int32
# fun regitr_loop(*) : Int32
# fun regitr_copy(*, *) : Void

# Unknow types
# ["__time_t", "__suseconds_t", "__syscall_slong_t", ":pointer", "__pthread_list_t", ":array", "union", "__off_t", "__mbstate_t", "__off64_t", ":enum", "struct", ":bitfield", "kstring_t", "htsFormat", "hts_pos_t", ":function-pointer", "intmax_t", "imaxdiv_t", "uintmax_t", "__gwchar_t", ":long-double", "fd_set", ":struct", "__sigset_t", "__compar_fn_t", "div_t", "ldiv_t", "lldiv_t", "wchar_t", "locale_t", "FILE", "__gnuc_va_list", "fpos_t", "va_list", "ks_tokaux_t", "hts_opt", "htsFile", "htsThreadPool", "hts_idx_t", "hts_name2id_f", "hts_itr_t", "BGZF", "hts_id2name_f", "hts_reglist_t", "errmod_t", "probaln_par_t", "hts_md5_context", ":unsigned-char", "regidx_parse_f", "regidx_free_f", "regidx_t", "regitr_t"]
# caller
...
# regitr_t, hts_pos_t, convert.rb:79:in `block (2 levels) in <main>'
# regitr_t, hts_pos_t, convert.rb:79:in `block (2 levels) in <main>'
# regitr_t, :pointer, convert.rb:79:in `block (2 levels) in <main>'
# regitr_t, :pointer, convert.rb:79:in `block (2 levels) in <main>'
# regitr_t, :pointer, convert.rb:79:in `block (2 levels) in <main>'
...
# hts_reg2bin, hts_pos_t, convert.rb:104:in `block (2 levels) in <main>'
# regidx_parse_bed, hts_pos_t, convert.rb:100:in `block (2 levels) in <main>'
# regidx_parse_bed, hts_pos_t, convert.rb:100:in `block (2 levels) in <main>'
# regidx_parse_tab, hts_pos_t, convert.rb:100:in `block (2 levels) in <main>'
# regidx_parse_tab, hts_pos_t, convert.rb:100:in `block (2 levels) in <main>'
# regidx_parse_reg, hts_pos_t, convert.rb:100:in `block (2 levels) in <main>'
# regidx_parse_reg, hts_pos_t, convert.rb:100:in `block (2 levels) in <main>'
# regidx_parse_vcf, hts_pos_t, convert.rb:100:in `block (2 levels) in <main>'
# regidx_parse_vcf, hts_pos_t, convert.rb:100:in `block (2 levels) in <main>'
# regidx_init, regidx_parse_f, convert.rb:104:in `block (2 levels) in <main>'
# regidx_init, regidx_free_f, convert.rb:104:in `block (2 levels) in <main>'
# , regidx_t, convert.rb:109:in `block in <main>'
# regidx_init_string, regidx_parse_f, convert.rb:104:in `block (2 levels) in <main>'
# regidx_init_string, regidx_free_f, convert.rb:104:in `block (2 levels) in <main>'
# , regidx_t, convert.rb:109:in `block in <main>'
# regidx_destroy, regidx_t, convert.rb:100:in `block (2 levels) in <main>'
# regidx_overlap, regidx_t, convert.rb:100:in `block (2 levels) in <main>'
# regidx_overlap, hts_pos_t, convert.rb:104:in `block (2 levels) in <main>'
# regidx_overlap, hts_pos_t, convert.rb:104:in `block (2 levels) in <main>'
# regidx_overlap, regitr_t, convert.rb:100:in `block (2 levels) in <main>'
# regidx_insert, regidx_t, convert.rb:100:in `block (2 levels) in <main>'
# regidx_insert_list, regidx_t, convert.rb:100:in `block (2 levels) in <main>'
# regidx_push, regidx_t, convert.rb:100:in `block (2 levels) in <main>'
# regidx_push, hts_pos_t, convert.rb:104:in `block (2 levels) in <main>'
# regidx_push, hts_pos_t, convert.rb:104:in `block (2 levels) in <main>'
# regidx_seq_names, regidx_t, convert.rb:100:in `block (2 levels) in <main>'
# , :pointer, convert.rb:109:in `block in <main>'
# regidx_seq_nregs, regidx_t, convert.rb:100:in `block (2 levels) in <main>'
# regidx_nregs, regidx_t, convert.rb:100:in `block (2 levels) in <main>'
# regitr_init, regidx_t, convert.rb:100:in `block (2 levels) in <main>'
# , regitr_t, convert.rb:109:in `block in <main>'
# regitr_destroy, regitr_t, convert.rb:100:in `block (2 levels) in <main>'
# regitr_reset, regidx_t, convert.rb:100:in `block (2 levels) in <main>'
# regitr_reset, regitr_t, convert.rb:100:in `block (2 levels) in <main>'
# regitr_overlap, regitr_t, convert.rb:100:in `block (2 levels) in <main>'
# regitr_loop, regitr_t, convert.rb:100:in `block (2 levels) in <main>'
# regitr_copy, regitr_t, convert.rb:100:in `block (2 levels) in <main>'
# regitr_copy, regitr_t, convert.rb:100:in `block (2 levels) in <main>'
