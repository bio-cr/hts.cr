...
# fun regidx_parse_bed(LibC::Char*, LibC::Char**, LibC::Char**, *, *, Void*, Void*) : Int32
# fun regidx_parse_tab(LibC::Char*, LibC::Char**, LibC::Char**, *, *, Void*, Void*) : Int32
# fun regidx_parse_reg(LibC::Char*, LibC::Char**, LibC::Char**, *, *, Void*, Void*) : Int32
# fun regidx_parse_vcf(LibC::Char*, LibC::Char**, LibC::Char**, *, *, Void*, Void*) : Int32
# fun regidx_init(LibC::Char*, , , SizeT, Void*) : *
# fun regidx_init_string(LibC::Char*, , , SizeT, Void*) : *
# fun regidx_destroy(*) : Void
# fun regidx_overlap(*, LibC::Char*, , , *) : Int32
# fun regidx_insert(*, LibC::Char*) : Int32
# fun regidx_insert_list(*, LibC::Char*, LibC::Char) : Int32
# fun regidx_push(*, LibC::Char*, LibC::Char*, , , Void*) : Int32
# fun regidx_seq_names(*, Int32*) : *
# fun regidx_seq_nregs(*, LibC::Char*) : Int32
...
# Unknown types
# ["__time_t", "__suseconds_t", "__syscall_slong_t", ":array", ":enum", "struct", ":bitfield", "kstring_t", "union", "htsFormat", "hts_idx_t", ":struct", "hts_pos_t", "hts_pair_pos_t", "hts_reglist_t", "hts_pair64_max_t", ":function-pointer", "intmax_t", "imaxdiv_t", "uintmax_t", "__gwchar_t", ":long-double", "fd_set", "__sigset_t", "__compar_fn_t", "div_t", "ldiv_t", "lldiv_t", "wchar_t", "locale_t", "FILE", "__gnuc_va_list", "__off_t", "fpos_t", "va_list", "ks_tokaux_t", "hts_opt", "htsFile", ":pointer", "htsThreadPool", "hts_name2id_f", "hts_itr_t", "BGZF", "hts_id2name_f", "errmod_t", "probaln_par_t", "hts_md5_context", ":unsigned-char", "regidx_parse_f", "regidx_free_f", "regidx_t", "regitr_t"]
# timeval, __time_t
